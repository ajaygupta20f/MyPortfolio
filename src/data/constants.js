  ...
  // },
  {
    ...
    skills: [
      ...
      },
      {
        name: "Postman",
        image:
          "https://d3f1iyfxxz8i1e.cloudfront.net/courses/course_image/d0e6428c3101.png",
      },
      {
        name: "Eclipse",
        image:
...
export const projects = [
  ...
  },
  {
    ...
    description:
      " Face-Time app project, which is a web-based video conferencing platform that allows users to connect through video, audio, and chat. This clone would replicate the core features of Zoom, enabling users to host and join virtual meetings. Allow users to join meetings with video and audio, including support for multiple participants.",
    image:
